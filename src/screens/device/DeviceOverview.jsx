...
import standBack from "../../assets/icons/standBy.png";
import insideFeedback from "../../assets/icons/insideFeedback.png";
    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* Details */}
          <div className="d-flex" style={{ gap: '5rem' ,alignItems:'center', flexWrap:'wrap'}}>
            <div className="container" style={{ display: "flex", flexDirection: "row", gap: "10rem", width: "50%", boxShadow: "0px 0px 50px #00000029", borderRadius: "15px", padding: "1rem", marginLeft: "0px" }}>
            ...
            <div style={{ width: "30%", marginRight: "10%" }}>
              {status === "ACTIVE" ?
                <img src={insideFeedback} style={{ objectFit: 'cover' }} />
                :
                <img src={standBack} style={{ objectFit: 'cover' }} />
              }
            </div>
          </div>
          {/* device data */}
