          ...
          >
            ...
            <div className={Style.Container}>
              ...
              <Row className="mt-0">
                ...
                <div className='d-flex' style={{gap:"5rem",padding:"10px",marginLeft:"2.3rem"}}>
                                      ...
                                      <React.Fragment key={_id}>
                                        <section className={Style.tableBody}>
                                          ...
                                          >
                                            ...
                                            <svg width="40px" height="40px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#ff0000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M12 9.5C13.3807 9.5 14.5 10.6193 14.5 12C14.5 13.3807 13.3807 14.5 12 14.5C10.6193 14.5 9.5 13.3807 9.5 12C9.5 10.6193 10.6193 9.5 12 9.5Z" fill="#ff0000"></path> </g></svg>
                                            </>:""}
                                          </section>
                                          {regDetail &&
                                            regDetail
