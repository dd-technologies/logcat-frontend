...
// import { deviceAction, getRegisteredDetailsById, registerNewDevice } from '../../store/action/DeviceAction';
...
//   const getRegisteredDetails = useSelector((state)=>state.getRegisteredDetails);
//   const {data1} = getRegisteredDetails;
//   // console.log('check',getRegisteredDetails.data.data)


//   // let regData =  data1 && data1.data;
//   // console.log('data1',regData.data.data)
...
// const sendData = (EditDetails) =>{
//   setEditDetails(EditDetails);
// }
// console.log('sendData',EditDetails.AliasName)
...
//     )
//   )
// },[dispatch,EditDetails.AliasName])
...
export default function DeviceTable(){
  ...
  const {data1} = getRegisteredDetailsReducer;
 ...
 /**
  ...
  console.log('first',initialState.DeviceId)
  let navigate = useNavigate(); 
  const routeChange = () =>{ 
    let path = `/deviceLogs?code=${code}&projectName=${projectName}&DeviceId=${item.did}`; 
    navigate(path);
