...
const sortTableFnDID = (callbackDispatchAllData) => {
  // Sort By Device Id
  if (currentStateEvents.sortIcons.DID) {
    return callbackDispatchAllData('-did');
  } else if (!currentStateEvents.sortIcons.DID) {
...
const sortTableFnMSG = (callbackDispatchAllData) => {
  // Sort By Message
  if (currentStateEvents.sortIcons.MSG) {
    return callbackDispatchAllData('-message');
  } else if (!currentStateEvents.sortIcons.MSG) {
    multpleDispatchSort(SORT_ICONS, {
      DID: false,
      MSG: true,
      DT: false,
...
const sortTableFnDT = (callbackDispatchAllData) => {
  // DT -- date TI-- time
  if (currentStateEvents.sortIcons.DT || currentStateEvents.sortIcons.TI) {
    return callbackDispatchAllData('-date');
  } else if (
                        ...
                        <section className={Style.tableHeader}>
                          ...
                          <section className={Style.innerHeader}>
                            ...
                            <FontAwesomeIcon
                              ...
                              style={{ cursor: 'pointer' }}
                              icon={
                                currentStateEvents.sortIcons.DID
                                  ? faSortDown
                                  : faSortUp
                              }
                              onClick={() => {
                                dispatchEventsData({
                                  ...
                                  data: {
                                    ...
                                    DID: !currentStateEvents.sortIcons.DID,
                                  },
                                });
                                sortTableFnDID(callbackfnDispatchGetAllData);
                              }}
                            />
                          </section>
                          <section className={Style.innerHeader}>
                            ...
                            <FontAwesomeIcon
                              ...
                              style={{ cursor: 'pointer' }}
                              icon={
                                currentStateEvents.sortIcons.MSG
                                  ? faSortDown
                                  : faSortUp
                              }
                              onClick={() => {
                                dispatchEventsData({
                                  ...
                                  data: {
                                    ...currentStateEvents.sortIcons,
                                    MSG: !currentStateEvents.sortIcons.MSG,
                                  },
                                });
                                sortTableFnMSG(callbackfnDispatchGetAllData);
                              }}
                            />
                          </section>
                          <section className={Style.innerHeader}>
