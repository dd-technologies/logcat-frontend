...
//     (state) => state.forgetPasswordReducer
//   );
//   const { loading, forgetPasswordInfo,data} = forgetPasswordReducer;
//   console.log('forgetPasswordInfo' , forgetPasswordInfo)
//    // useEffect(()=>{
...
//     // if (forgetPasswordInfo && forgetPasswordInfo.statusValue=='SUCCESS'){
//     //   toast.success(forgetPasswordInfo && forgetPasswordInfo.message)
//     //   dispatch(forgetPassword(email))
//     // }
//     setForgetEmailErr(null);
//   }
