...
const Register = () => {
  ...
  console.log("stateName",registerForm.stateName)
  ...
  console.log("registerForm",registerForm.hospitalName)
  // state data 
  ...
  const countryChange=(e)=>{
    console.log("duck",e.target.value)
    setRegisterForm({
      ...registerForm,
  ...
  const stateChange=(e)=>{
    console.log("duck2",e.target.value)
    setRegisterForm({
      ...registerForm,
  ...
  const getAllCountryData=Country.getAllCountries()
            ...
            <div className="Form-card">
              <form>
                ...
                >
                  ...
                  {hospitalData && hospitalData.map((item)=>{
                     return( 
                      <option 
                      style={{padding:"4px",border:"0px",width:"100%"}}
