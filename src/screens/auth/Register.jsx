...
const Register = () => {
  ...
  const validatePassword = (passwordHash, confirmPassword) => {
    if (!passwordHash) {
      setPasswordError({
        ...passwordError,
        passwordHash: "*Please enter your passwordHash.",
      });
      return false;
    } else {
    ...
    if (!confirmPassword) {
      setPasswordError({
        ...passwordError,
        confirmPassword: "Please enter your Confirm passwordHash.",
      });
      return false;
    } else {
  ...
  const handleSubmit = async (e) => {
    ...
    console.log("registerForm.hospitalName",registerForm.hospitalName)
    if (!registerForm.firstName) {
      setFNameError("*Please fill Full name field");
      return false;
    } 
    else {
      setFNameError(null);
    ...
    if (!registerForm.hospitalName) {
      setHospitalError("Please fill Hospital name field");
      return false;
    } 
    else {
