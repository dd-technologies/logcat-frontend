...
export default function Login() {
  ...
  const handleRememberPasswordChange = () => {
    setisRemeberMe(localStorage.getItem("rememberMe"));
  };
  ...
  const handleSubmit = async (e) => {
    ...
    if (email && passwordHash) {
      dispatch(loginWithEmail(loginForm.email, loginForm.passwordHash,isRemeberMe));
    }
    if(email=="" && passwordHash==""){
              ...
              <form>
                ...
                <div className={Style.remembersection} >
                  <div style={{
                    ...
                    <input type="checkbox"
                    checked={isRemeberMe}
                    onClick={handleRememberPasswordChange}
                    />
