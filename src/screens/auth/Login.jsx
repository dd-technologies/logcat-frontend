...
export default function Login() {
  ...
  //   e.preventDefault();
  //   const email = validateEmail(loginForm.email.toLowerCase());
  ...
  //   }
  //   else if(isRemeberMe == false){
  //     alert("remove remember me")
  //     localStorage.removeItem("rememberEmail");
  //     localStorage.removeItem("rememberPassword");
  //     localStorage.removeItem("rememberMe");
  //   }
  //   else if (isRemeberMe == true) {
  //     alert("select remember me")
  ...
  //   if (email && passwordHash) {
  //     dispatch(
  //       loginWithEmail(loginForm.email.toLowerCase(), loginForm.passwordHash, isRemeberMe)
  //     );
  //   }
  // };
  const handleSubmit = async (e) => {
                ...
                <div className={Style.remembersection}>
                  ...
                  >
                    <input
                      type="checkbox"
                      checked={isRemeberMe}
                      onClick={(e) => handleRememberPasswordChange(e)}
                    />
