...
export const adminRegister =
  (firstName,lastName, email,hospitalName, passwordHash,confirmPassword, navigate) => async (dispatch) => {
    try {
      dispatch({
...
// export const updateProfile = (email, firstName, avatar) => async (dispatch) => {
//   try {
//     // console.log("form data: ", email, firstName, avatar);
